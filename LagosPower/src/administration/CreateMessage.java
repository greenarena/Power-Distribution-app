...
//class will create a message and send to admin
public class CreateMessage{
 
	//get an instance of the database
	Database db=new Database();
	//select option, there's only one option here
	String[] items = {"Admin"};
	...
	public CreateMessage() {
		...
		window.setTitle("Send message to Admin");
	...
	public static void main(String[] args) {
		...
		CreateMessage sta = new CreateMessage();
