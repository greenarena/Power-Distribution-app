...
--
-- Table structure for table `felele`
--

DROP TABLE IF EXISTS `felele`;
...
CREATE TABLE `felele` (
  ...
  `dateScheduled` varchar(45) NOT NULL,
  PRIMARY KEY (`idintochallenge`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `felele`
--

LOCK TABLES `felele` WRITE;
/*!40000 ALTER TABLE `felele` DISABLE KEYS */;
INSERT INTO `felele` VALUES (1,'26-09-2017','Felele','LightUp','LightUp','LightUp','LightUp','LightUp','LightUp','LightUp','LightUp',24,'2017-09-24 09:33:33');
/*!40000 ALTER TABLE `felele` ENABLE KEYS */;
UNLOCK TABLES;
